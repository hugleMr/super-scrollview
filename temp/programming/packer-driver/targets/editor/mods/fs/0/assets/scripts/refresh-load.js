System.register(["cce:/internal/code-quality/cr.mjs", "cc", "./baseMain"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RefreshLoad", RefreshLoad = (_dec = ccclass('RefreshLoad'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = class RefreshLoad extends (_crd && BaseMain === void 0 ? (_reportPossibleCrUseOfBaseMain({
        error: Error()
      }), BaseMain) : BaseMain) {
        constructor(...args) {
          super(...args);
