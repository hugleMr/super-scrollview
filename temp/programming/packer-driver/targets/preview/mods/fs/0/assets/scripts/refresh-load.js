System.register(["cce:/internal/code-quality/cr.mjs", "cc", "./baseMain"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Node, Tween, Vec3, Label, BaseMain, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, RefreshLoad;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "89a5cQ/qBdEaLFyit/snMpv", "refresh-load", undefined);

      ccclass = _decorator.ccclass;
      property = _decorator.property;

      _export("RefreshLoad", RefreshLoad = (_dec = ccclass('RefreshLoad'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ref) {
        _inheritsLoose(RefreshLoad, _ref);
        ...
        var _proto = RefreshLoad.prototype;
...
//# sourceMappingURL=refresh-load.js.map