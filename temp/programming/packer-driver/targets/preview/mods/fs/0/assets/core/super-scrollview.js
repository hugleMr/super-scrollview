System.register(["cce:/internal/code-quality/cr.mjs", "cc", "./super-layout"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, _decorator, Vec3, Vec2, ScrollView, EventHandler, SuperLayout, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _temp, _crd, ccclass, property, quintEaseOut, EPSILON, OUT_OF_BOUNDARY_BREAKING_FACTOR, SuperScrollview;
  ...
  function _reportPossibleCrUseOfSuperLayout(extras) {
    _reporterNs.report("SuperLayout", "./super-layout", _context.meta, extras);
  }
  ...
  return {
    ...
    }, function (_superLayout) {
      SuperLayout = _superLayout.SuperLayout;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "72cf528Z4dK+ofNYmM2Xf22", "super-scrollview", undefined);
      ...
      _export("SuperScrollview", SuperScrollview = (_dec = ccclass('SuperScrollview'), _dec2 = property({
        displayName: "顶部偏移量",
        ...
        _inheritsLoose(SuperScrollview, _ScrollView);

        function SuperScrollview() {
          var _this;
        ...
        var _proto = SuperScrollview.prototype;
        ...
        _createClass(SuperScrollview, [{
          key: "layout",
          get: function get() {
            if (!this._layout) {
              var _this$content;

              this._layout = (_this$content = this.content) === null || _this$content === void 0 ? void 0 : _this$content.getComponent(_crd && SuperLayout === void 0 ? (_reportPossibleCrUseOfSuperLayout({
                error: Error()
...
//# sourceMappingURL=super-scrollview.js.map