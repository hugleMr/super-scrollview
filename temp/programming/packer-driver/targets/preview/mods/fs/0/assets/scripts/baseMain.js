  ...
  return {
    ...
    execute: function () {
      ...
      _export("BaseMain", BaseMain = (_dec = ccclass('BaseMain'), _dec2 = property(_crd && SuperLayout === void 0 ? (_reportPossibleCrUseOfSuperLayout({
        error: Error()
      }), SuperLayout) : SuperLayout), _dec3 = property(EditBox), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        _inheritsLoose(BaseMain, _Component);
        ...
        var _proto = BaseMain.prototype;

        _proto.toHeader = function toHeader() {
          this.layout.scrollToHeader(1);
        };

        _proto.toFooter = function toFooter() {
          this.layout.scrollToFooter(1);
        };

        _proto.toIndex = function toIndex() {
        ...
        _proto.addItem = function addItem(event, args) {
        ...
        return BaseMain;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "layout", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
